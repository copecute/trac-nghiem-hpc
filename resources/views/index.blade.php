...
<path d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.41-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
  ...
  c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="#E43" /> <animateTransform attributeName="transform" begin="0s" dur="3s" type="rotate" from="0 31 37" to="360 31 37" repeatCount="indefinite" < animateTransform>
</g>
<g id="small">
...
<h2>Xin lỗi vì sự bất tiện này.<br>Để liên lạc với chúng tôi trong thời gian chờ đợi, vui lòng liên hệ</h2>
<a href="mailto:{{ config('mail.from.address') }}">{{ config('mail.from.address') }}</a><h2>hoặc gọi <span>088 888 9530</span></h2>
</div>
<div>
